...
int main(int argc, char **argv)
{
    ...
    string author = "Apurv and Abhishek";
...
void setPosition(string &input, std::vector<string> &inputVector, Board &board)
{
    ...
    if (input.find("fen") != string::npos)
    {
        ...
        {
            pos = inputVector.at(2) + ' ' + inputVector.at(3) + ' ' + inputVector.at(4) + ' ' + inputVector.at(5);
        }
        else
        {
            pos = inputVector.at(2) + ' ' + inputVector.at(3) + ' ' + inputVector.at(4) + ' ' + inputVector.at(5) + ' ' + inputVector.at(6) + ' ' + inputVector.at(7);
        }
    }
...
Move stringToMove(const string &moveStr, Board &b, bool &reversible)
{
    ...
    int promotion = (moveStr.length() == 5)
                        ? promotionString.find(moveStr.at(4))
                        : 0;
...
string boardToFEN(Board &board)
{
    ...
    if (board.getWhiteCanKCastle())
    {
        hasCastles = true;
        fenString += 'K';
    }
    if (board.getWhiteCanQCastle())
    {
        hasCastles = true;
        fenString += 'Q';
    }
    if (board.getBlackCanKCastle())
    {
        hasCastles = true;
        fenString += 'k';
    }
    if (board.getBlackCanQCastle())
    {
        hasCastles = true;
        fenString += 'q';
    }
